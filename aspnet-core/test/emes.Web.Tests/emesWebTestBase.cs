...
{
    public abstract class emesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static emesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(emesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<emesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<emesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<emesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<emesDbContext, Task<T>> func)
        {
            T result;
