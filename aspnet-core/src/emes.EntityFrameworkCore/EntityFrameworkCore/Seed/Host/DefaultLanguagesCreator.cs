...
namespace emes.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly emesDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = emesConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(emesDbContext context)
        {
            _context = context;
        }
